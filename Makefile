...
#when deploy on real net, make sure the subscriptionId is valid
deploy:
...
enterRaffle:
	@cast send $(RAFFLE_ADDRESS) "enterRaffle()" --value 10000000000000000 --rpc-url $(SEPOLIA_RPC_URL) --account $(ACCOUNT)
